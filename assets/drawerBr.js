...
var arianna = (function (arianna) {
	...
	arianna.drawer = (function (drawer) {
		...
		var drawCurrNode = function (stato) {
				...
				drawer.currNode.setAttribute("r", 15);
			};
		...
		drawer.animate = function (oldstate) {
			if (nodesEqual (oldstate.currNode,drawer.state.currNode)){
				return;
			}
...
window.onload = function () {
	...
	stateA = JSON.parse('{"currNode":{"x":300,"y":525},"succ":"P3","curr":"P1"}');
	stateB = JSON.parse('{"currNode":{"x":300,"y":525},"succ":"P4","curr":"P1"}');
	stateC = JSON.parse('{"currNode":{"x":300,"y":525},"succ":"P5","curr":"P1"}');
	stateD = JSON.parse('{"currNode":{"x":300,"y":225},"succ":"P6","curr":"P1"}');

	//document.write ("porcamadonna");
	path = JSON.parse('[{"x":660,"y":75},{"x":660,"y":105},{"x":780,"y":105},{"x":780,"y":165},{"x":660,"y":165},{"x":660,"y":345},{"x":600,"y":345},{"x":600,"y":405},{"x":720,"y":405},{"x":720,"y":345},{"x":780,"y":345},{"x":780,"y":405},{"x":900,"y":405},{"x":900,"y":525},{"x":840,"y":525},{"x":840,"y":465},{"x":660,"y":465},{"x":660,"y":525},{"x":780,"y":525},{"x":780,"y":585},{"x":720,"y":585},{"x":720,"y":585},{"x":600,"y":585},{"x":600,"y":525},{"x":300,"y":525},{"x": 300,"y": 525}, {"x": 300,"y": 345}, {"x": 360,"y": 345}, {"x": 360,"y": 285}, {"x": 300,"y": 285}, {"x": 300,"y": 225}]');
	...
	arianna.drawer.init("map", path, pois, stateA);
